...
class BillsAdapter (var activity: HomeActivity, private var billsList: List<Bills>):
    RecyclerView.Adapter<BillsAdapter.ItemViewHolder>() {
    class ItemViewHolder(val binding: BillRowBinding) : RecyclerView.ViewHolder(binding.root)
